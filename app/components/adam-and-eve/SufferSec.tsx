...
import contentSecImg from '@/public/images/adam-and-eve/suffer-img.svg';

const SufferSec = () => {
  return (
    <div className="my-10 lg:my-40 bg-[#902c86] text-white lg:px-40 flex lg:flex-row  flex-col-reverse  items-center p-4 gap-6 justify-between flex-wrap">
      ...
      <div className="lg:flex-1">
        ...
        <ul className="list-disc p-4 text-white">
          ...
          <li>
            <p className="self-stretch text-right justify-start  text-base lg:text-xl font-normal">
              احتياج للطرف الآخر وضعفى أمامه {' '}
            </p>
          </li>
          <li>
            <p className="self-stretch text-right justify-start  text-base lg:text-xl font-normal">
