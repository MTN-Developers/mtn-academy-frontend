...
export default function OurDiplomas() {
  return (
    <div className="container mx-auto my-32 flex items-center justify-center flex-col">
      ...
      <p className="text-gray-700 font-normal">Take a new step towards your career</p>
        ...
        {diplomasInfo.map((diploma, index) => {
          return (
            ...
            >
              ...
              <h2 className="text-primary-blue text-center font-bold text-2xl">{diploma.title}</h2>
